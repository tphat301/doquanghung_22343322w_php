                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control text-sm" name="data[quantity]" id="quantity" placeholder="Số lượng" value="<?=(!empty($flash->has('quantity'))) ? $flash->get('quantity') : @$item['quantity']?>">
