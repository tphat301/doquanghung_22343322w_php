<?php  
	...
	/* Lấy bài viết tĩnh */
	$static = $d->rawQueryOne("select id, type, name$lang, content$lang, photo, date_created, date_updated, options from #_static where type = ? limit 0,1",array('ve-chung-toi'));
