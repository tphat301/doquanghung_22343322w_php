...
$social_follow = $cache->get("select photo, link from #_photo where type = ? and find_in_set('hienthi',status) order by numb asc", array('social-footer-follow'), 'result', 7200);
